...
public partial class @InputMaster: IInputActionCollection2, IDisposable
{
    ...
    private List<IWASDMouseActions> m_WASDMouseActionsCallbackInterfaces = new List<IWASDMouseActions>();
    ...
    public struct WASDMouseActions
    {
        ...
        public void AddCallbacks(IWASDMouseActions instance)
        {
            if (instance == null || m_Wrapper.m_WASDMouseActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_WASDMouseActionsCallbackInterfaces.Add(instance);
            @Movement.started += instance.OnMovement;
            @Movement.performed += instance.OnMovement;
            @Movement.canceled += instance.OnMovement;
            @Jump.started += instance.OnJump;
        ...
        private void UnregisterCallbacks(IWASDMouseActions instance)
        {
            @Movement.started -= instance.OnMovement;
            @Movement.performed -= instance.OnMovement;
            @Movement.canceled -= instance.OnMovement;
        ...
        public void RemoveCallbacks(IWASDMouseActions instance)
        {
            if (m_Wrapper.m_WASDMouseActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IWASDMouseActions instance)
        {
            foreach (var item in m_Wrapper.m_WASDMouseActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_WASDMouseActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<ITemplateActions> m_TemplateActionsCallbackInterfaces = new List<ITemplateActions>();
    ...
    public struct TemplateActions
    {
        ...
        {
            if (instance == null || m_Wrapper.m_TemplateActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_TemplateActionsCallbackInterfaces.Add(instance);
            @Movement.started += instance.OnMovement;
            @Movement.performed += instance.OnMovement;
            @Movement.canceled += instance.OnMovement;
            @Jump.started += instance.OnJump;
        ...
        private void UnregisterCallbacks(ITemplateActions instance)
        {
            @Movement.started -= instance.OnMovement;
            @Movement.performed -= instance.OnMovement;
            @Movement.canceled -= instance.OnMovement;
        ...
        {
            if (m_Wrapper.m_TemplateActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ITemplateActions instance)
        {
            foreach (var item in m_Wrapper.m_TemplateActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_TemplateActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
